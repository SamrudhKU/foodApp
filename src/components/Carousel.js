...
export default function Carousel() {
  return (
    <div className="carousel slide" data-bs-ride="carousel" style={{"objectFit":"contain !important"}}>
  ...
  <form class="d-flex">
    ...
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/900x700/?panner " className="d-block w-100"  alt="..."/>
    </div>
  </div>
